...
struct Series {
    std::string kind;
    ::cheatah::ndarray::basic_ndarray<double> x;
    ::cheatah::ndarray::basic_ndarray<double> y;
    ::cheatah::ndarray::basic_ndarray<double> ylo;
    ::cheatah::ndarray::basic_ndarray<double> yhi;
...
inline Series blank(builtins::Value auto&& kind) {
    ...
    return Series{
        .kind = static_cast<std::string>(kind),
        .x = static_cast<::cheatah::ndarray::basic_ndarray<double>>(ndarray::zeros(std::vector{0LL})),
        .y = static_cast<::cheatah::ndarray::basic_ndarray<double>>(ndarray::zeros(std::vector{0LL})),
        .ylo = static_cast<::cheatah::ndarray::basic_ndarray<double>>(ndarray::zeros(std::vector{0LL})),
        .yhi = static_cast<::cheatah::ndarray::basic_ndarray<double>>(ndarray::zeros(std::vector{0LL})),
...
/// @return the module name (`"series"`).
inline const char* module_abi() noexcept { return "series"; }

}  // namespace cheatah::series

// Re-exported under the host namespace (--reexport cheatah::plot):
namespace cheatah::plot { namespace series = ::cheatah::series; }
